                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="summary entry-summary">
                                    ...
                                    <p class="taller">
                                        <%=furnitures.get(0).getDescription()%>
                                    </p>
                                    <p>
                                    ...
                                    <div class="product_meta">
                                        <span class="posted_in">Category: <a rel="tag" href="../../ECommerce_FurnitureCategoryServlet?cat=<%=URLEncoder.encode(f.getCategory())%>"><%=f.getCategory()%></a></span>
                                    </div>
                                    <br/><br/>
